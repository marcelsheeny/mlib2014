...
public class Test2 {
    ...
    private static double[][] count_training_trans (Integer[] genome, Integer[] annotation)
    {
        ...
        Viterbi.initPseudoCountMatrix(trans);
        double[] div = new double[2];
        Viterbi.initPseudoCountVector(div, trans[0].length);
    ...
    private static double[][] count_training_emi (Integer[] genome, Integer[] annotation)
    {
        ...
        Viterbi.initPseudoCountMatrix(emi);
        double[] div = new double[2];
        Viterbi.initPseudoCountVector(div, emi[0].length);
    ...
    public static void run()
    {
        ...
        String genome = Viterbi.read_fasta("genome5.fa");
        String annotation = Viterbi.read_fasta("annotation5.fa");
    ...
    public static void runCV()
    {
        ...
        String genome = Viterbi.read_fasta("genome3.fa");
        String annotation = Viterbi.read_fasta("annotation3.fa");
